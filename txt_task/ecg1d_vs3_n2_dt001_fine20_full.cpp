...
int run_free() {
    ...
    cfg.config_name = "legacy_prb_3_3_n2_pathpad_K32_dt0p01_fine20_free";
    cfg.model = "legacy_prb_3_3_n2_pathpad_K32_dt0p01_fine20_free";
    cfg.out_root = "out/vs3_n2_dt0p01_T160pi_K32_sweep_fine20/free";
    ...
    opt.config_appendix =
        "driver=ecg1d_vs3_n2_dt001_fine20_full_free\n"
...
int run_gauss(double sigma) {
    ...
    cfg.config_name = "legacy_prb_3_3_n2_pathpad_K32_dt0p01_fine20_gauss_sigma" + stag;
    cfg.model = "legacy_prb_3_3_n2_pathpad_K32_dt0p01_fine20_gauss_sigma" + stag;
    cfg.out_root = "out/vs3_n2_dt0p01_T160pi_K32_sweep_fine20/gauss_sigma" + stag;
    ...
    opt.config_appendix +=
        "driver=ecg1d_vs3_n2_dt001_fine20_full_gauss\n"
...
int main(int argc, char** argv) {
    try {
        ...
        std::filesystem::create_directories("out/vs3_n2_dt0p01_T160pi_K32_sweep_fine20");
        ...
        std::cerr << "FATAL vs3 N2 dt=0.01 fine20 full run: " << e.what() << "\n";
        return 2;
    }
}
