...
pumpconfig::PumpConfig make_vs3_n2_base() {
    ...
    cfg.K = 32;
    cfg.dt = 5.0e-4;
    cfg.manual_fine_dt_enabled = false;
    cfg.manual_fine_dt_factor = 1.0;
    cfg.manual_fine_dt_windows_s.clear();
    cfg.manual_fine_dt_schedule_s.clear();
...
int run_free() {
    ...
    cfg.config_name = "legacy_prb_3_3_n2_pathpad_K32_dt0p0005_repeat_free";
    cfg.model = "legacy_prb_3_3_n2_pathpad_K32_dt0p0005_repeat_free";
    cfg.out_root = "out/vs3_n2_dt0p01_T160pi_K32_sweep_full20_repeat/free";
    ...
    opt.config_appendix =
        "driver=ecg1d_vs3_n2_dt0005_full_repeat_free\n"
        "hamiltonian_kinetic=1\n"
        "hamiltonian_delta=0\n"
        "hamiltonian_gaussian=0\n"
        "dt_mode=full_cycle_dt_over_20_repeat\n"
        "dt_planning_estimate_seconds_per_step=0.10\n"
        "dt_planning_estimate_steps=1005310\n"
        "dt_planning_estimate_wall_hours=27.9\n";
...
int run_gauss(double sigma) {
    ...
    cfg.config_name = "legacy_prb_3_3_n2_pathpad_K32_dt0p0005_repeat_gauss_sigma" + stag;
    cfg.model = "legacy_prb_3_3_n2_pathpad_K32_dt0p0005_repeat_gauss_sigma" + stag;
    cfg.out_root = "out/vs3_n2_dt0p01_T160pi_K32_sweep_full20_repeat/gauss_sigma" + stag;
    ...
    opt.config_appendix +=
        "driver=ecg1d_vs3_n2_dt0005_full_repeat_gauss\n"
        "sweep_parameter=sigma_gauss\n"
        "sweep_sigma_gauss_code=" + std::to_string(sigma) + "\n"
        "dt_mode=full_cycle_dt_over_20_repeat\n"
        "dt_planning_estimate_seconds_per_step=0.23\n"
        "dt_planning_estimate_steps=1005310\n"
        "dt_planning_estimate_wall_hours=64.2\n";
    return pump2::run_pump(cfg, opt);
}
...
int main(int argc, char** argv) {
    try {
        ...
        std::filesystem::create_directories("out/vs3_n2_dt0p01_T160pi_K32_sweep_full20_repeat");
        ...
        std::cerr << "FATAL vs3 N2 dt=0.0005 full-cycle repeat run: " << e.what() << "\n";
        return 2;
    }
}
